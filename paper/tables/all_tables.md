...
| ChemBERTa               | 0.7016 / 0.7699+/-0.0151 | --                       | --                       | --                       | --                       | 1.4122 / 1.4957+/-0.1998 | 0.9984 / 1.0753+/-0.0837 | --                       |
| Hybrid                  | 0.7525 / 0.8222+/-0.0174 | --                       | --                       | --                       | --                       | 1.1999 / 0.9872+/-0.0798 | 0.7528 / 0.7603+/-0.1235 | --                       |
| Ensemble                | 0.7514 / 0.8223+/-0.0239 | --                       | --                       | --                       | --                       | 1.1463 / 0.9778+/-0.0984 | 0.7529 / 0.7602+/-0.1245 | --                       |
...
| ChemBERTa frozen        | 0.6987 / 0.7818+/-0.0210 | --                       | --                       | 0.7254 / 0.8296+/-0.0438 | 0.5757 / 0.5826+/-0.0413 | 1.3624 / 1.4319+/-0.2574 | 0.9220 / 1.0205+/-0.1254 | 3.1958 / 2.1755+/-0.4670 |
| ChemBERTa + LoRA        | 0.7109 / 0.7936+/-0.0296 | --                       | --                       | 0.7154 / 0.8126+/-0.0630 | 0.5974 / 0.5808+/-0.0491 | 1.1943 / 1.1144+/-0.1846 | 0.8745 / 0.9457+/-0.1352 | 3.1790 / 1.8350+/-0.2099 |
...
| Fusion: concat          | 0.7430 / 0.8166+/-0.0272 | 0.7301 / 0.8934+/-0.0566 | 0.9242 / 0.8633+/-0.1463 | 0.7917 / 0.8445+/-0.0695 | 0.5537 / 0.5747+/-0.0219 | 0.8708 / 0.8592+/-0.1190 | 0.7286 / 0.6852+/-0.0306 | 2.1421 / 0.9828+/-0.2236 |
| Fusion: gated           | 0.7487 / 0.8268+/-0.0261 | 0.7380 / 0.8942+/-0.0412 | 0.7564 / 0.8512+/-0.0891 | 0.8178 / 0.8328+/-0.0763 | 0.5818 / 0.6219+/-0.0340 | 0.9316 / 0.8353+/-0.1599 | 0.7364 / 0.6963+/-0.0212 | 2.1735 / 1.1044+/-0.3133 |
| Fusion: x-attn          | 0.7548 / 0.8146+/-0.0296 | 0.7349 / 0.8950+/-0.0320 | 0.8926 / 0.8369+/-0.1062 | 0.8170 / 0.8575+/-0.0699 | 0.5971 / 0.5916+/-0.0373 | 0.8705 / 0.8499+/-0.1048 | 0.7196 / 0.7145+/-0.0270 | 2.1685 / 0.9419+/-0.2516 |
| Fusion: bilinear        | 0.7603 / 0.8267+/-0.0287 | 0.7570 / 0.9022+/-0.0406 | 0.8114 / 0.8198+/-0.1485 | 0.8158 / 0.8513+/-0.0766 | 0.5868 / 0.6158+/-0.0490 | 0.8357 / 0.8268+/-0.1406 | 0.7318 / 0.6841+/-0.0298 | 2.0150 / 1.0372+/-0.3661 |
| Fusion: proposed        | 0.7410 / 0.8248+/-0.0209 | 0.7385 / 0.9071+/-0.0405 | 0.8980 / 0.8512+/-0.0875 | 0.8112 / 0.8573+/-0.0747 | 0.6142 / 0.6380+/-0.0114 | 0.8720 / 0.7832+/-0.1020 | 0.7086 / 0.6887+/-0.0350 | 1.8966 / 0.9559+/-0.2688 |
| Fusion: concat (e2e)    | 0.7194 / 0.8062+/-0.0224 | --                       | --                       | 0.7935 / 0.8345+/-0.0840 | 0.5425 / 0.5389+/-0.0319 | 0.9609 / 0.9663+/-0.1528 | 0.7619 / 0.7205+/-0.0420 | 2.1389 / 1.3941+/-0.3563 |
| Fusion: gated (e2e)     | 0.7309 / 0.8235+/-0.0167 | --                       | --                       | 0.8043 / 0.8282+/-0.0836 | 0.6035 / 0.6399+/-0.0519 | 0.9123 / 0.9175+/-0.2207 | 0.7239 / 0.6927+/-0.0339 | 2.1553 / 1.3108+/-0.1763 |
| Fusion: proposed (e2e)  | 0.7176 / 0.8174+/-0.0177 | --                       | --                       | 0.7833 / 0.8558+/-0.0817 | 0.5370 / 0.6309+/-0.0278 | 0.9407 / 0.8430+/-0.1173 | 0.7425 / 0.6955+/-0.0085 | 1.9289 / 1.0018+/-0.2363 |
| Fusion: gated, no graph | 0.7634 / 0.8211+/-0.0350 | 0.7050 / 0.9103+/-0.0307 | 0.8257 / 0.8395+/-0.1575 | 0.8357 / 0.8481+/-0.0888 | 0.6157 / 0.6245+/-0.0449 | 0.7781 / 0.8671+/-0.2314 | 0.7205 / 0.6819+/-0.0208 | 2.0095 / 0.9803+/-0.2931 |
