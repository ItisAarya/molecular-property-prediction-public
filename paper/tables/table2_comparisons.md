...
|-------------------------------------------------|-------------|------------|-------------------|----------|------------------|-------------------|
| fuse_bilinear_gpu vs fuse_concat_gpu            | 1+ / 0-     | 1+ / 0-    | 8/8               | 0.0078   | 0.0078           | 0.0078            |
...
| fuse_bilinear_r32_gpu vs fuse_bilinear_gpu      | 0+ / 0-     | 0+ / 0-    | 2/8               | 0.2891   | 0.0391           | 0.1094            |
| desc vs gin_ref                                 | 1+ / 0-     | 0+ / 0-    | 7/8               | 0.0703   | 0.0547           | 0.0781            |
| fuse_bilinear_r16_gpu vs fuse_concat_gpu        | 1+ / 0-     | 1+ / 0-    | 6/8               | 0.2891   | 0.0547           | 0.1953            |
...
| fuse_bilinear_r128_gpu vs fuse_concat_gpu       | 2+ / 0-     | 0+ / 0-    | 6/8               | 0.2891   | 0.0781           | 0.1484            |
| fuse_bilinear_r32_gpu vs fuse_concat_gpu        | 2+ / 0-     | 1+ / 0-    | 6/8               | 0.2891   | 0.1094           | 0.1094            |
| fuse_bilinear_r128_gpu vs fuse_bilinear_gpu     | 0+ / 0-     | 0+ / 0-    | 3/8               | 0.7266   | 0.1094           | 0.1094            |
| fuse_proposed_gpu vs fuse_xattn_gpu             | 1+ / 0-     | 0+ / 0-    | 7/8               | 0.0703   | 0.1094           | 0.1953            |
...
| fuse_proposed_gpu vs fuse_bilinear_gpu          | 0+ / 0-     | 0+ / 0-    | 3/8               | 0.7266   | 0.5469           | 0.6406            |
| fuse_xattn_gpu vs fuse_concat_gpu               | 1+ / 0-     | 0+ / 0-    | 5/8               | 0.7266   | 0.5469           | 0.2500            |
...
| fuse_bilinear_r16_gpu vs fuse_bilinear_gpu      | 0+ / 0-     | 0+ / 0-    | 3/8               | 0.7266   | 0.6406           | 0.1953            |
...
| fuse_bilinear_r128_gpu vs fuse_bilinear_r16_gpu | 0+ / 0-     | 0+ / 0-    | 3/8               | 0.7266   | 0.8438           | 0.5469            |
